...
<html>
  ...
  <body>
    <div id="wrapper">
      ...
      <center><h2 style="color: #271065">Choose your course</h2></center>
      ...
      ?>
        <div class="Rtable-cell">
          <h3>
            <a href="courseslist.php#computerscience"
              > 
      ...
      ?>
        <div class="Rtable-cell">
          <h3>
            <a href="courseslist.php#electrical"
              > 
